              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      class="pt"
                      v-on:click="changeImage(thumbs[0])"
                      v-bind:class="thumbs[0] == gambar_default ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      v-on:click="changeImage(thumbs[1])"
                      v-bind:class="thumbs[1] == gambar_default ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      v-on:click="changeImage(thumbs[2])"
                      v-bind:class="thumbs[2] == gambar_default ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      v-on:click="changeImage(thumbs[3])"
                      v-bind:class="thumbs[3] == gambar_default ? 'active' : ''"
                    >
